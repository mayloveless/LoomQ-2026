...
class RealHardwareServiceTests(unittest.TestCase):
    ...
    @mock.patch("loomq.real_hardware._backend", return_value="gemini")
    ...
    @mock.patch("loomq.real_hardware._require_configured", return_value="gemini")
    def test_get_job_returns_normalized_status(self, configured, query_task):
        ...
        query_task.assert_called_once_with("task-123")
